...
class Customer extends Component {
  ...
  async updateRequestRecords() {
    console.log("inside updateRequestRecords");
    const { data: requests } = await axios.get('/BankRequests');
    console.log("after updateRequestRecords");
  ...
  onKycRequestSubmit = async (e) => {
    ...
    try {
      var x=this.state.name+this.state.aadhar;
        ...
        this.state.customerDataHash=result;
        ...
        <div class="row">
          <div class="container left" style={{ padding: "30px 0px 0px 30px" }}>
            ...
            <form class="col s5" onSubmit={this.onKycRequestSubmit}>
              ...
              <input placeholder="Customer Id" id="customerId" type="text" className="input-control" name="customerId" onChange={this.inputChangedHandler} required/></label>
              <label>
              Enter Name:
                  <input placeholder="Name" type="text" value={this.state.name} onChange={this.handleChange1} required/>        </label>
                  <label>
                  Enter Aadhar Number:
                  <input placeholder="Aadhar" type="number" value={this.state.aadhar} onChange={this.handleChange2} required/>        </label><br></br>
                  <label>Aadhar photocopy</label> <input placeholder="Aadhar" type="file"  alt="Submit" width="48" height="48" required></input><br></br><br></br>
